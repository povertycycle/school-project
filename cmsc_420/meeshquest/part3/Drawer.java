...
import cmsc420.meeshquest.part3.MetropoleNode.MetropoleType;
...
//			if (map.getMetropoleRoot().nodeType() != MetropoleType.WHITE && library.insideMap.isEmpty() == false) {
//				processMap(canvas, library);
//			}
//			if (pmquadtree.roadListIsNotEmpty(Float.parseFloat(x), Float.parseFloat(y), Float.parseFloat(radius))) {
//				TreeSet<Geo2D> listOfGeometries = pmquadtree.getRoot().getGeometries();
